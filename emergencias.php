...
<head>
    <meta charset="UTF-8">
    <title>Emergencias - Veterinaria</title>
...
<body>
    ...
    <main class="container my-4">
        ...
        <p>Por favor, contacta a nuestra clínica inmediatamente a través del siguiente número:</p>
        <p><strong>Teléfono de Emergencias: 1234-5678</strong></p>
    </main>
